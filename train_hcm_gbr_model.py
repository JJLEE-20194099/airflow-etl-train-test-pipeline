...
@dag("train_hcm_gbr_model", tags = ["train_hcm_gbr_model"], schedule='0 10,19 * * *', catchup=False, start_date=datetime(2024, 6, 6))
def taskflow():

    @task(task_id="train_hcm_gbr_model", retries=0)
    def train():
        ...
        gbr_model = gbr.create_model(pretrained_file = pretrained_file)
        ...
        train_gbr_model_run_id = mlflow_train_model(
            ...
            experiment_name = f'hcm_gbr_realestate_{EXP}',
