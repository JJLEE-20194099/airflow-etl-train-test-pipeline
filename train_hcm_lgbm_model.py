...
@dag(dag_id="train_hcm_lgbm_model", tags = ["train_hcm_lgbm_model"], schedule="*/59 * * * *", catchup=False, start_date=datetime(2024, 6, 6))
def taskflow():

    @task(task_id="train_hcm_lgbm_model", retries=2)
    def train():
