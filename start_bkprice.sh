...
tmux new-session -d -s hcm_other 'celery -A utils.train_func worker -c 1 -Q hcm_other --loglevel=INFO' & \
tmux new-session -d -s hn_other 'celery -A utils.train_func worker -c 1 -Q hn_other --loglevel=INFO' & \
