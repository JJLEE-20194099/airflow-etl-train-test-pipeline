...
def build_offline_batch_data(standard_data):
    data = get_compact_realestate_info(standard_data)
    ...
    for administrative_genre, city in zip(administrative_genre_list, city_list):
        ...
        mean_land_size_list.append(mean_land_size_df[mean_land_size_df['administrative_genre'] == data['administrative_genre']].iloc[0]['meanLandSize'])
