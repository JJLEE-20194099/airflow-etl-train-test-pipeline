...
@dag("train_hcm_la_model", tags = ["train_hcm_la_model"], schedule="*/59 * * * *", catchup=False, start_date=datetime(2024, 6, 6))
def taskflow():

    @task(task_id="train_hcm_la_model", retries=2,execution_timeout=timedelta(hours=24))
    def train():
        ...
        train_la_model_run_id = mlflow_train_model(
            ...
            experiment_name = 'hcm_la_realestate_num_version_training',
