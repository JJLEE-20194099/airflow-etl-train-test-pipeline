...
# @dag("train_hn_rf_model", tags = ["train_hn_rf_model"], schedule='0 10,19 * * *', catchup=False, start_date=datetime(2024, 6, 6))
# def taskflow():

#     @task(task_id="train_hn_rf_model_v0", retries=0)
#     def train_v0():
#         train_model_by_city_data_and_feature_version(city = 'hcm', version = 0, model_name = 'rf')

#     @task(task_id="train_hn_rf_model_v1", retries=0)
#     def train_v1():
#         train_model_by_city_data_and_feature_version(city = 'hcm', version = 1, model_name = 'rf')

#     @task(task_id="train_hn_rf_model_v2", retries=0)
#     def train_v2():
#         train_model_by_city_data_and_feature_version(city = 'hcm', version = 2, model_name = 'rf')

#     @task(task_id="train_hn_rf_model_v4", retries=0)
#     def train_v4():
#         train_model_by_city_data_and_feature_version(city = 'hcm', version = 4, model_name = 'rf')

#     @task(task_id="train_hn_rf_model_v5", retries=0)
#     def train_v5():
